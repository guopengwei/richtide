/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af86e79ba65e7f55bd1b87493184c6b9)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "development";
	IDENTITY: DurableObjectNamespace<import("./src/worker").IdentityDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "IdentityDurableObject";
	}
